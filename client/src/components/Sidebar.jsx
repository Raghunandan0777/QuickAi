...
const Sidebar = ({ sidebar, setSidebar }) => {
  ...
  return (
    <div
      className={`w-60 bg-white border-r border-gray-200 flex flex-col justify-between items-center max-sm:absolute top-14 bottom-0 z-10 ${sidebar ? "left-0" : "-left-60"} sm:left-0 transition-all duration-300 ease-in-out`}
    >
